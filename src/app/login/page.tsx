                        ...
                        <div className="flex items-start py-2">
                            <div className="flex items-center h-5 mt-0.5">
                                <input
                                    ...
                                    type="checkbox"
                                    required
                                    className="w-4 h-4 border border-gray-700 rounded bg-gray-950 accent-lime-500 cursor-pointer"
                                />
                            </div>
                            <div className="ml-3 text-xs text-gray-400">
                                <label htmlFor="terms" className="cursor-pointer">
                                    Confirmo que uso a ferramenta apenas para apoio à consulta, restando a intervenção ao critério técnico exclusivo.
                                </label>
                            </div>
                        </div>

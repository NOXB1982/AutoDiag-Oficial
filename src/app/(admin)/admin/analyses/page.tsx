...
import { Activity, Car, Calendar, Info, Cpu, FileText, Eye } from "lucide-react"
                                    ...
                                    <tr key={analysis.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <Link 
                                                ...
                                                className="inline-flex items-center justify-center p-2 bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 rounded-lg transition-colors border border-blue-100 dark:border-blue-800 focus:ring-2 focus:ring-blue-500/50"
